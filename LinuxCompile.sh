...
g++ -o LocalizationAnalysis -std=c++0x -O2 -ffast-math -D NDEBUG -mtune=core2 -lgsl -lcblas -latlas -lboost_date_time -lboost_filesystem -lboost_thread -lfftw3 -ltiff -lboost_program_options ./source/PALM_analysis_CommandLine.cpp ./source/PALM_analysis.cpp ./source/PALM_analysis_Convolver.cpp ./source/PALM_analysis_FileIO.cpp ./source/PALM_analysis_Localization.cpp ./source/PALM_analysis_PALMImages.cpp ./source/PALM_analysis_ParticleFinding.cpp ./source/PALM_analysis_Processing.cpp ./source/PALM_analysis_segmentation.cpp ./source/PALM_analysis_storage.cpp ./source/PALM_analysis_MatrixRecycler.cpp
