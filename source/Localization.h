...
public:
    ...
    virtual std::shared_ptr<LocalizedPositionsContainer> fit_positions(const ImagePtr image, std::shared_ptr<std::list<Particle> > particles) = 0;
};
...
public:
    ...
    std::shared_ptr<LocalizedPositionsContainer> fit_positions(const ImagePtr image, std::shared_ptr<std::list<Particle> > particles);
